...
import logo from "../assets/หมูโลโก้.jpg";
      ...
      <div className="flex items-center h-full justify-between">
        ...
        <div className="flex items-center gap-4 md:gap-7 ">
          <nav className="gap-4 md:gap-6 text-base md:text-lg hidden md:flex">
            <Link to={""}>Home</Link>
            <Link to={"menu/64b99a6d652a3fd0607824b0"}>Menu</Link>
          ...
          <div className=" text-slate-600" onClick={headerShowMenu}>
            ...
            {showMenu && (
              <div className="absolute right-2 bg-white py-2 px-2 shadow drop-shadow-md flex flex-col min-w-[120px] text-center">
                ...
                <nav className="text-base md:text-lg flex flex-col md:hidden">
                  ...
                  <Link
                    to={"menu/64a6b2e948339c9787d28f5e"}
                    className=" px-2 py-1"
                  >
                    Menu
                  </Link>
